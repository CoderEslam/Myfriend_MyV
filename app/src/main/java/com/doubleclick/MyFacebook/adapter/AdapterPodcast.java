...
import com.doubleclick.MyFacebook.podcast.PodcastActivity;
...
public class AdapterPodcast extends RecyclerView.Adapter<AdapterPodcast.MyHolder>{
    ...
    int channelProfile;
    public static final String channelMessage = "com.doubleclick.myfacebook.CHANNEL";
    public static final String profileMessage = "com.doubleclick.myfacebook.PROFILE";
