package com.spacester.myfriend.groupVoiceCall.openacall.model;
    ...
    private RtcEngine ensureRtcEngineReadyLock() {
        if (mRtcEngine == null) {
            ...
            try {
                ...
                mRtcEngine = RtcEngine.create(mContext, "3ff1177808494805ad3e9a3bfd539e0e", mEngineEventHandler.mRtcEventHandler);
            } catch (Exception e) {
